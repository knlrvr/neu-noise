  ...
  return (
    <div className="max-w-7xl mx-auto py-20">
      <div className="flex flex-col space-y-20">
        <div className="border-2 border-[#222] bg-red-500 p-12 mr-2 relative">
          ...
          <div className="bg-red-600 absolute bottom-2 right-2 border-2 border-[#222] rounded-full h-12 w-12 flex justify-center items-center text-2xl group cursor-pointer">
            <BiRightArrowAlt 
        ...
        <div className="border-2 border-[#222] bg-blue-500 p-12 mr-2 relative">
          ...
          <div className="bg-blue-600 absolute bottom-2 right-2 border-2 border-[#222] rounded-full h-12 w-12 flex justify-center items-center text-2xl group cursor-pointer">
            <BiRightArrowAlt 
              className="group-hover:-rotate-45 transition duration-200" />
          </div>
          <div className="absolute w-full h-full top-3 left-3 bg-[#222] -z-10"></div>
        ...
        <div className="border-2 border-[#222] bg-purple-500 p-12 mr-2 relative">
          ...
          <div className="bg-purple-600 absolute bottom-2 right-2 border-2 border-[#222] rounded-full h-12 w-12 flex justify-center items-center text-2xl group cursor-pointer">
            <BiRightArrowAlt 
              className="group-hover:-rotate-45 transition duration-200" />
          </div>
          <div className="absolute w-full h-full top-3 left-3 bg-[#222] -z-10"></div>
