    ...
    <div className="max-w-7xl mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-3 border-t-2 border-b-2 border-[#222] relative">
        ...
        <div className="border-b-2 md:border-b-0 md:border-r-2 border-[#222] p-12 flex flex-col relative">
          ...
          <div className="absolute top-[92%] right-3/5 md:top-1/2 md:-right-6 bg-blue-500 rounded-full h-12 w-12 border-2 border-[#222] flex justify-center items-center text-2xl">
            <BiRightArrowAlt 
              className="rotate-90 md:rotate-0" />
          </div>
        </div>
